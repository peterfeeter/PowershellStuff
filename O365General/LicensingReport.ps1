...
$FinalCSV = "C:\temp\finallicence_" + ($license.accountskuid -replace ":","_") + "_" + (Get-Date -Format "yyyyMMdd") + ".csv"
Import-Csv -Path $LicenseTypeReport -Delimiter ';' | Export-Csv -Path $FinalCSV -Delimiter ',' -NoType
