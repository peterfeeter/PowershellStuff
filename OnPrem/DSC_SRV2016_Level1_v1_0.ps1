...
Configuration CIS_WindowsServer2016_v100_MS_lvl1 {
    ...
    Node $NodeName {
        #GJ Comment: N/A Windows firewall is turned off
        ...
        SecurityOption AccountSecurityOptions {
            ...
            Audit_Force_audit_policy_subcategory_settings_Windows_Vista_or_later_to_override_audit_policy_category_settings = 'Disabled' # 2.3.2.1 (L1) Ensure 'Audit: Force audit policy subcategory settings (Windows Vista or later) to override audit policy category settings' is set to 'Enabled'
            ...
            #Interactive_logon_Message_text_for_users_attempting_to_log_on = "This system, including all related equipment, network devices and Internet access (the System) is restricted to authorised use only.`r By using the System you agree that you are authorised to do so.`r If you are not authorised to use the System, you must discontinue any use of the System immediately.`r Unauthorised use, or misuse, of the System is a violation of applicable laws, regulations and policies and may subject you to criminal prosecution." # 2.3.7.4 (L1) Configure 'Interactive logon: Message text for users attempting to log on'  
            Interactive_logon_Message_title_for_users_attempting_to_log_on = 'Disclaimer' # 2.3.7.5 (L1) Configure 'Interactive logon: Message title for users attempting to log on'  
            ...
            Network_security_Configure_encryption_types_allowed_for_Kerberos = 'RC4_HMAC_MD5', 'AES128_HMAC_SHA1', 'AES256_HMAC_SHA1', 'Future'  # 2.3.11.4 (L1) Ensure 'Network security: Configure encryption types allowed for Kerberos' is set to 'RC4_HMAC_MD5, AES128_HMAC_SHA1,AES256_HMAC_SHA1, Future encryption types'
            ...
            User_Account_Control_Admin_Approval_Mode_for_the_Built_in_Administrator_account = 'disabled' # 2.3.17.1 (L1) Ensure 'User Account Control: Admin Approval Mode for the Built-in Administrator account' is set to 'Enabled'
            ...
            User_Account_Control_Run_all_administrators_in_Admin_Approval_Mode = 'Disabled' # 2.3.17.7 (L1) Ensure 'User Account Control: Run all administrators in Admin Approval Mode' is set to 'Enabled'
